      ...
      <List>
        <Box>
          ...
          <P>
            ...
            Some of the pages and features I played a major role in: <br/>
              - Desktop navigation <br/>
              - Checkout <br/>
              - The gift card flow <br/>
        ...
        <Box>
          ...
          <P>
            ...
            projects: the catalog, and checkout. <br/> <br/>
            
            The catalog portion consisted of an es5 backbone application, that was 
            managed with a propetary CMS.<br/><br/>
